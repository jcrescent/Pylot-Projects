...
routes['GET']['/show/<product_id>'] = 'products#show'
routes['GET']['/edit/<product_id>'] = 'products#edit'
routes['POST']['/update/<product_id>'] = 'products#update'
routes['POST']['/delete/<product_id>'] = 'products#remove'
# """
