...
"""
routes['default_controller'] = 'book_review'
routes['GET']['/add_book_page'] = 'book_review#add_book_page' 
routes['POST']['/add_book'] = 'book_review#add_book'
routes['GET']['/users/<user_id>'] = 'book_review#view_user'
routes['GET']['/books'] = 'book_review#home'
routes['GET']['/books/<book_id>'] ='book_review#show_book'
routes['POST']['/']
"""
