...
"""
routes['default_controller'] = 'User_dashboard'
routes['GET']['/'] = 'User_dashboard#index'
routes['GET']['/registration'] = 'User_dashboard#registration'
routes['POST']['/register'] = 'User_dashboard#register'
routes['GET']['/admin_dashboard'] = 'User_dashboard#admin_dashboard'
routes['GET']['/new'] = 'User_dashboard#register'
routes['GET']['/wall/<user_id>'] = 'User_dashboard#show_wall'
routes['POST']['/login'] = 'User_dashboard#login'
routes['POST']['/post_message/<user_id>'] = 'User_dashboard#post_message'
routes['POST']['/post_comment/<message_id>/user<id>'] = 'User_dashboard#post_comment'
